...
| ---------------------------- | -------------------------------------------------------------- | ---------------------------- | -------------------------- |
| mode                         | 0: buttons, 1: item range, 2: page number. If using mode 1, the paginator should be called with "item", or setNumItems should be called after all pages are added.| Number                       | 0                          |
